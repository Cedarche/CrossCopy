...
export default function Privacy() {
  return (
    <Container>
      <Header style={{ fontSize: '50px' }}>CROSS COPY</Header>
      <SubContainer>
        <div class="row">
          <div class="col">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  means of the processing of consumers' personal information, that does business in
              ...
              <li>
                <p>
                  ...
                  in this Agreement) refers to crosscopy.dev website.
                </p>
              ...
              <li>
                <p>
                  ...
                  electronic or other means, a Consumer's personal information to another business
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to crosscopy.dev, accessible from{' '}
                  <a href="https://www.crosscopy.dev" target="_blank">
                    https://www.crosscopy.dev
                  </a>
                </p>
              </li>
              <li>
            ...
            <p>
              At Cross Copy, we currently do not use Cookies. However, we may use Cookies and
              similar tracking technologies in the future to track the activity on Our Service and
              store certain information. The technologies We may use include:
            </p>
            <ul>
              <li>
                <strong>Firebase Analytics Cookies.</strong> In the future, we may implement
                Firebase Analytics to analyze and measure user interaction with our website.
                Firebase Analytics may use cookies to collect information and report website usage
                statistics without personally identifying individual visitors to Google.
              </li>
              <li>
                <strong>Google AdSense Cookies.</strong> In the future, we may implement Google
                AdSense to serve ads. Google AdSense uses cookies to serve ads based on a user's
                prior visits to your website or other websites. You may opt out of personalized
            ...
            <p>
              Persistent Cookies may be used if we implement Firebase Analytics or Google AdSense in
              the future. These services use Persistent Cookies to remember your preferences, track
              your visits, and target ads based on your browsing habits.
            </p>
            <p>
              If you do not wish to accept cookies from us in the future, you can instruct your
              browser to stop accepting cookies or to prompt you before accepting a cookie from the
              websites you visit. However, if you do not accept cookies, you may not be able to use
              all portions or all functionalities of our Service.
            </p>
            ...
            <ul>
              <li>
                Your information is not sold or shared with third parties unless it's necessary to
                provide the Service, comply with the law, or protect the rights, property, or safety
                of our users, the public, or Cross Copy.
              </li>
            </ul>
            ...
            <p>
              At Cross Copy, we currently do not use Your Personal Data for email marketing
              purposes. This means we do not send newsletters, marketing or promotional materials
              via email. If our policy on email marketing changes in the future, we will update this
              section of our privacy policy and will provide options for opting out of such
              communications.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  ...
                  transcripts, class lists, student schedules, student identification codes, student
            ...
            <ul>
              ...
              <li>
                ...
                Service Providers may set on Your Device as You navigate through our Service.
              </li>
              <li>
                <strong>From Service Providers</strong>. For example, third-party vendors to monitor
                and analyze the use of our Service, third-party vendors for payment processing, or
            ...
            <p>
              At Cross Copy, we respect your privacy and prioritize the protection of your data. We
              do not sell any personal information to third parties. This applies to all categories
              of personal data we collect, including but not limited to Identifiers, Personal
              information categories listed in the California Customer Records statute (Cal. Civ.
              Code § 1798.80(e)), Commercial information, and Internet or other similar network
              activity.
            </p>
            <p>
              If our policy on the sale of personal information changes in the future, we will
              update this section of our privacy policy and will provide options for opting out of
              such practices.
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>The right to request.</strong> Under CCPA, You have the right to request
                that We disclose information to You about Our collection, use, sale, disclosure for
                business purposes and share of personal information. Once We receive and confirm
              ...
              <li>
                <strong>The right to say no to the sale of Personal Data (opt-out).</strong> You
                have the right to direct Us to not sell Your personal information. Cross Copy does
                not sell user information to third parties.
              </li>
              <li>
                <strong>The right to delete Personal Data.</strong> You have the right to request
                the deletion of Your Personal Data, subject to certain exceptions. Once We receive
                ...
                may deny Your deletion request if retaining the information is necessary for Us or
              ...
              <li>
                ...
                to be discriminated against for exercising any of Your consumer's rights, including
                by:
                <ul>
            ...
            <ul>
              <li>
                ...
                <a href="https://www.crosscopy.dev/contact/" target="_blank">
                  https://www.crosscopy.dev/contact/
                </a>
              </li>
            </ul>
            <p>
