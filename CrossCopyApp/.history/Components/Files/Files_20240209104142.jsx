...
import { FileStyles } from "../Home/Styles/FileStyles";
import { ModalStyles } from "../Home/Styles/ModalStyles";
      ...
      <BottomSheetModalProvider>
        ...
        <View style={styles.subContainer}>
          <View style={styles.bottomContainer}>
            ...
            <TouchableOpacity style={[styles.bottomButton, { marginRight: -1 }]}>
          ...
          <TouchableWithoutFeedback onPress={() => setModalVisible(false)}>
            <View style={ModalStyles.modalOverlay}>
              ...
              <TouchableWithoutFeedback onPress={(e) => e.stopPropagation()}>
                ...
                >
                  <TouchableOpacity style={ModalStyles.modalRow} onPressIn={pickImages}>
                    <Text style={ModalStyles.modalText}>Photo Library</Text>
                    <Feather name="image" style={{color: '#fff'}} size={20}/>
                  </TouchableOpacity>
                  <View style={ModalStyles.divider}/>
                  <TouchableOpacity style={ModalStyles.modalRow} onPressIn={takePhoto}>
                    <Text style={ModalStyles.modalText}>Take photo or video</Text>
                    <Feather name="camera" style={{color: '#fff'}} size={20}/>
                  </TouchableOpacity>
                  <View style={ModalStyles.divider}/>
                  <TouchableOpacity style={ModalStyles.modalRow} onPressIn={scanDocument}>
                    <Text style={ModalStyles.modalText}>Scan document</Text>
                    <MaterialIcons name="document-scanner" size={20} style={{color: '#fff'}} />
                  </TouchableOpacity>
                  <View style={ModalStyles.divider}/>
                  <TouchableOpacity style={[ModalStyles.modalRow, {borderBottomWidth: 0}]} onPressIn={pickFile}>
