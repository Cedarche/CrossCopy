    ...
    ImagePicker.openPicker({
      ...
      .then((images) => {
        images.forEach((image) => {
          console.log(image)
          const fileUri = image.sourceURL; // Use the 'path' property for the file URI
          const fileName = image.filename ? image.filename.replace(/\..+$/, ".jpg") : `${Date.now()}.jpg`; // Replace any existing extension with '.jpg'
...
const FileItem = ({ file, openSheet, handleRemoveFile }) => {
