...
const ShareOptions = () => {
  return (
    <View style={[styles.subContainer, {alignItems: 'center', paddingTop: 10}]}>
      <View style={styles.QRcontainer}>
        <QRCode
          ...
          backgroundColor="#383838"
        />
        <Text style={{fontSize: 16, color: '#fff', marginTop: 10}}>Scan QR code or tap to share natively</Text>
      </View>
    </View>
  );
};
