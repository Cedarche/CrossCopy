  ...
  return (
    <Tab.Navigator    screenOptions={{
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused, color, size }) => <Feather name="home" size={20} color={color} />,
        }}
      />
      <Tab.Screen
        name="History"
        ...
        options={{
          tabBarIcon: ({ focused, color, size }) => <Feather name="list" size={20} color={color} />,
        }}
      />
      <Tab.Screen
        name="Files"
        children={() => <Files files={files} setFiles={setFiles} paidUser={paidUser} />}
        options={{
