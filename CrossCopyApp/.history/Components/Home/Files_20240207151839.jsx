...
export default function Files({ files, setFiles, paidUser }) {
  ...
  const [flatListHeight, setFlatListHeight] = useState(0); // State to hold FlatList height
      ...
      <BottomSheetModalProvider>
        ...
        <View style={styles.subContainer}>
          ...
          <View style={FileStyles.addItemContainer}>
            <TouchableOpacity style={FileStyles.addItemButton}>
              <Feather name="file-plus" style={{color: '#c6c6c6'}} size={40} />
              <Text style={FileStyles.addItemText}>Press to select photos or files</Text>
            </TouchableOpacity>
          </View>
        </View>
        <BottomSheetModal
