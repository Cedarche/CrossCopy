...
class ShareViewController: SLComposeServiceViewController {
 ...
 let hostAppBundleIdentifier = "com.cedarche.CrossCopyApp"
 let shareProtocol = "com.cedarche.CrossCopyApp" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
